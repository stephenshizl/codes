...
int main(int argc, char *argv[])
{
	...
	/*fb_dev.fb_var.yres_virtual = fb_dev.fb_var.yres * 2;*/
	/*fb_dev.fb_var.yoffset = 0 * fb_dev.fb_var.yres;*/
	/*fb_dev.fb_var.bits_per_pixel = 16;*/
	/*if (ioctl(fb_dev.fd, FBIOPUT_VSCREENINFO, &fb_dev.fb_var) < 0) {*/
